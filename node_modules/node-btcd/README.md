# A Node.JS BitcoinDark Client!

![BitcoinDark](http://static.tumblr.com/ppdj5y9/Ae9mxmxtp/300coin.png)

node-btcd is a BitcoinDark client for Node.JS. It is a fork of the excellent BitcoinDark intended for use with BitcoinDark.

* Provide a one-stop resource for the Node.JS developer to get started with BitcoinDark integration.
* Prevent would-be BitcoinDark web developers worrying whether the Bitcoin client will work out of the box.
* Promote Node.JS development of BitcoinDark web apps.
* Identify and address any incompatibilities with the BitcoinDark and Bitcoin APIs that exist now and/or in the future.

## Dependencies

You'll need a running instance of [BitcoinDarkd](https://github.com/btcd/btcd) to connect with.

Then, install the node-btcd NPM package.

`npm install node-btcd`
...
btcd.auth('myusername', 'mypassword')

btcd.getDifficulty(function() {
...
TODO: Verify and test with BitcoinDark.
...
```js
btcd.getNewAddress(function(err, address) {
...
```js
btcd.exec('getNewAddress')

btcd.exec('getbalance', function(err, balance) {
...
TODO: Verify and test these with BitcoinDark.
...
<td> <b>Currently only available on testnet</b> Add a nrequired-to-sign multisignature address to the wallet. Each key is a btcd address or hex-encoded public key. If [account] is specified, assign address to [account]. </td>
<td> N
</td></tr>
<tr>
<td> backupwallet </td>
...
<td> dumpprivkey </td>
<td> [btcdaddress] </td>
<td> Reveals the private key corresponding to <btcdaddress< </td>
<td> Y
</td></tr>
<tr>
<td> encryptwallet </td>
...
<td> [account] </td>
<td> Returns the current btcd address for receiving payments to this account. </td>
<td> N
</td></tr>
<tr>
...
<td> getgenerate </td>
<td> </td>
<td> Returns true or false whether BitcoinDarkd is currently generating hashes </td>
<td> N
</td></tr>
<tr>
...
<td> getnewaddress </td>
<td> [account] </td>
<td> Returns a new btcd address for receiving payments.  If [account] is specified (recommended), it is added to the address book so payments received with the address will be credited to [account]. </td>
<td> N
</td></tr>
<tr>
...
<td> [btcdaddress] [minconf=1] </td>
<td> Returns the total amount received by <btcdaddress< in transactions with at least [minconf] confirmations. While some might consider this obvious, value reported by this only considers *receiving* transactions. It does not check payments that have been made *from* this address. In other words, this is not "getaddressbalance". Works only for addresses in the local wallet, external addresses will always show 0. </td>
<td> N
</td></tr>
<tr>
...
<p>To get a list of accounts on the system, execute BitcoinDarkd listreceivedbyaddress 0 true
</p>
</td>
<td> N
</td></tr>
...
<tr>
<td> sendfrom </td>
<td> [fromaccount] [tobtcdaddress] [amount] [minconf=1] [comment] [comment-to] </td>
...
<td> stop </td>
<td> </td>
<td> Stop btcd server. </td>
<td> N
</td></tr>
<tr>
<td> validateaddress </td>
<td> [btcdaddress] </td>
<td> Return information about [btcdaddress]. </td>
<td> N
</td></tr>
<tr>
<td> verifymessage </td>
<td> [btcdaddress] [signature] [message] </td>
